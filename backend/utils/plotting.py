...
def discrete_cmap():
    ...
    r1 = ['#DCDCDC', '#b3de69', '#000000', '#8dd3c7', '#fdb462',
             '#fccde5', '#80b1d3', '#808080', '#fb8072', '#696969',
             '#577a4d', '#ffffb3']
    cmap_rooms = colors.ListedColormap(r1, name='rooms')
    mpl.colormaps.register(cmap_rooms)
    # --- icons -----------------------------------------------------------
    # its for icons
    # icon_classes = ["No Icon", "Window", "Door", "Closet", "Electrical Applience" ,"Toilet", "Sink",
    #                     "Sauna Bench", "Fire Place", "Bathtub", "Chimney"]
    i1 = ['#DCDCDC', '#8dd3c7', '#b15928', '#fdb462', '#ffff99',
             '#fccde5', '#80b1d3', '#808080', '#fb8072', '#696969',
             '#577a4d']
    cmap_icons = colors.ListedColormap(i1, name='icons')
    mpl.colormaps.register(cmap_icons)

    """create a colormap with N (N<15) discrete colors and register it"""
    # define individual colors as hex values
    # --- rooms_furu -----------------------------------------------------------
    rooms_furu1 = ['#DCDCDC', '#b3de69', '#000000', '#8dd3c7', '#fdb462',
             '#fccde5', '#80b1d3', '#808080', '#fb8072', '#696969',
             '#577a4d', '#ffffb3', 'd3d5d7']
    cmap_rooms_furu = colors.ListedColormap(rooms_furu1, name='rooms_furu')
    mpl.colormaps.register(cmap_rooms_furu)

    # --- icons_furu -----------------------------------------------------------
    rooms_furu2 = ['#DCDCDC', '#8dd3c7', '#b15928', '#fdb462', '#ffff99',
             '#fccde5', '#80b1d3', '#808080', '#fb8072', '#696969',
             '#577a4d']
    cmap_icons_furu = colors.ListedColormap(rooms_furu2, name='icons_furu')
    mpl.colormaps.register(cmap_icons_furu) 
